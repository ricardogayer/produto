...
class Auth {
    ...
    func autenticar(username: String, password: String, completion: @escaping (Result<Token, Error>) -> Void) {
        ...
        AF.request("http://localhost:8080/auth/realms/fitness/protocol/openid-connect/token", method: .post, parameters: parameters, encoder: URLEncodedFormParameterEncoder.default, headers: [header])
